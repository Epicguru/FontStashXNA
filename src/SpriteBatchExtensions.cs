...
namespace FontStashSharp
{
	public static class SpriteBatchExtensions
	{
			...
			int characterSpacing = 0, int lineSpacing = 0, float scaleX = 1.0f, float scaleY = 1.0f, float depth = 0.0f)
		{
			...
			return font.DrawText(renderer, pos.X, pos.Y, text, color, characterSpacing, lineSpacing, scaleX, scaleY, depth);
		}
			...
			int characterSpacing = 0, int lineSpacing = 0, float scaleX = 1.0f, float scaleY = 1.0f, float depth = 0.0f)
		{
			...
			return font.DrawText(renderer, pos.X, pos.Y, text, colors, characterSpacing, lineSpacing, scaleX, scaleY, depth);
		}
